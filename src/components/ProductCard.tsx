...
const ProductCard = ({ imageSrc, label, price, description, id, rating, numReviews, countInStock, discount }) => {
  ...
  return (
    <div className="bg-gradient-to-t from-white to-blue-500 from-10% rounded-lg drop-shadow-2xl shadow-l shadow-gray-200 overflow-hidden transition-all hover:scale-110">
            ...
            <div>
              ...
              <div className="p-4">
                <div className="flex h-20 items-center justify-between border-b border-zinc-200">
                  <h3 className="mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-3xl md:text-4xl text-gray-900">
                    {label}
                  </h3>
